...
lastNameInput.addEventListener("input", () => {
  ...
  else if (fullNameInput.value === "" && firstNameInput.value === "" && lastNameInput.value === "" && emailInput.value === "" && messageInput.value === "") reset.classList.remove('show');else if (fullNameInput.value === "" && firstNameInput.value === "" && lastNameInput.value === "" && emailInput.value === "" && messageInput.value === "") reset.classList.remove('show');
});
