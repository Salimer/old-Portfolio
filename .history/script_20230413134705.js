...
if (!localStorage.getItem('formObj.fullName')) populateStorage();
else setFormInput();

function populateStorage() {
  localStorage.setItem('formObj.fullName', fullNameInput.value);
...
fullNameInput.onchange = populateStorage;
